...
namespace eval OMPIF {
    proc create_message_sender_hier {} {
        set oldBdInstance [current_bd_instance .]
        variable messageSenderHier [create_bd_cell -type hier message_sender]

        current_bd_instance ${messageSenderHier}
        ...
        variable messageSenderIP [create_bd_cell -type ip -vlnv bsc:ompif:message_sender ompif_message_sender]
        ...
        return ${messageSenderHier}
    }

    proc create_message_receiver_hier {} {
        set oldBdInstance [current_bd_instance .]
        variable messageReceiverHier [create_bd_cell -type hier message_receiver]

        set addrWidth [AIT::board::get_addr_width]

        current_bd_instance ${messageReceiverHier}
        ...
        variable messageReceiverIP [create_bd_cell -type ip -vlnv bsc:ompif:message_receiver ompif_message_receiver]
        set_property -dict [list \
            CONFIG.MAX_DEVICES {96} \
        ...
        return ${messageReceiverHier}
    }

    set oldBdInstance [current_bd_instance .]
    variable hier [create_bd_cell -type hier OMPIF]
    ...
    variable clusterSizeSliceIP [create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice cluster_size_slice]
    set_property -dict [list \
        CONFIG.DIN_FROM {7} \
        CONFIG.DIN_TO {0} \
        CONFIG.DIN_WIDTH {16} \
    ...
    variable clusterRankSliceIP [create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice cluster_rank_slice]
    set_property -dict [list \
        CONFIG.DIN_FROM {15} \
        CONFIG.DIN_TO {8} \
        CONFIG.DIN_WIDTH {16} \
