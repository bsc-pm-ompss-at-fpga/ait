...
if {$::AIT::enable_spawn_queues} {
  ...
  connect_bd_intf_net [get_bd_intf_pins Smart_OmpSs_Manager/cmdout_in] [get_bd_intf_pins hwr_inStream/cmdout_in]
  connect_bd_intf_net [get_bd_intf_pins Smart_OmpSs_Manager/cmdin_out] [get_bd_intf_pins axis_cmdin_TID/S_AXIS]
  connect_bd_intf_net [get_bd_intf_pins hwr_outStream/cmdin_out] [get_bd_intf_pins axis_cmdin_TID/M_AXIS]
  connect_bd_intf_net [get_bd_intf_pins Smart_OmpSs_Manager/spawn_in] [get_bd_intf_pins hwr_inStream/spawn_in]
  connect_bd_intf_net [get_bd_intf_pins Smart_OmpSs_Manager/spawn_out] [get_bd_intf_pins axis_spawn_TID/S_AXIS]
  connect_bd_intf_net [get_bd_intf_pins hwr_outStream/spawn_out] [get_bd_intf_pins axis_spawn_TID/M_AXIS]
  connect_bd_intf_net [get_bd_intf_pins Smart_OmpSs_Manager/taskwait_in] [get_bd_intf_pins hwr_inStream/taskwait_in]
  connect_bd_intf_net [get_bd_intf_pins Smart_OmpSs_Manager/taskwait_out] [get_bd_intf_pins axis_taskwait_TID/S_AXIS]
  connect_bd_intf_net [get_bd_intf_pins hwr_outStream/taskwait_out] [get_bd_intf_pins axis_taskwait_TID/M_AXIS]
  if {${::AIT::lock_hwruntime}} {
    connect_bd_intf_net [get_bd_intf_pins Smart_OmpSs_Manager/lock_in] [get_bd_intf_pins hwr_inStream/lock_in]
    connect_bd_intf_net [get_bd_intf_pins Smart_OmpSs_Manager/lock_out] [get_bd_intf_pins axis_lock_TID/S_AXIS]
  ...
  connect_bd_net -net Smart_OmpSs_Manager_managed_aresetn [get_bd_pins managed_aresetn] [get_bd_pins Smart_OmpSs_Manager/managed_aresetn] [get_bd_pins axis_spawn_TID/aresetn] [get_bd_pins axis_taskwait_TID/aresetn] [get_bd_pins axis_cmdin_TID/aresetn]
  ...
  connect_bd_net -net interconnect_aresetn_1 [get_bd_pins interconnect_aresetn] [get_bd_pins GP_Inter/ARESETN] [get_bd_pins Smart_OmpSs_Manager/interconnect_aresetn] [get_bd_pins hwr_inStream/interconnect_aresetn] [get_bd_pins hwr_outStream/interconnect_aresetn]
