...
proc create_hier_cell_DDR_3 { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net S_AXI_1 [get_bd_intf_pins S_AXI] [get_bd_intf_pins DDR_S_AXI_regslice/S_AXI]
  ...
  connect_bd_net -net c0_ddr4_ui_clk [get_bd_pins ui_clk] [get_bd_pins DDR/c0_ddr4_ui_clk] [get_bd_pins DDR_S_AXI_regslice/aclk] [get_bd_pins DDR_proc_sys_reset/slowest_sync_clk]
  connect_bd_net -net c0_ddr4_ui_clk_sync_rst [get_bd_pins DDR/c0_ddr4_ui_clk_sync_rst] [get_bd_pins DDR_proc_sys_reset/ext_reset_in]
  connect_bd_net -net c0_init_calib_complete [get_bd_pins init_calib_complete] [get_bd_pins DDR/c0_init_calib_complete]
  connect_bd_net -net proc_sys_reset_peripheral_aresetn [get_bd_pins peripheral_aresetn] [get_bd_pins DDR/c0_ddr4_aresetn] [get_bd_pins DDR_S_AXI_regslice/aresetn] [get_bd_pins DDR_proc_sys_reset/peripheral_aresetn]
...
proc create_hier_cell_DDR_1 { parentCell nameHier } {
  ...
  connect_bd_net -net c0_ddr4_ui_clk_sync_rst [get_bd_pins DDR/c0_ddr4_ui_clk_sync_rst] [get_bd_pins DDR_proc_sys_reset/ext_reset_in]
  connect_bd_net -net c0_init_calib_complete [get_bd_pins init_calib_complete] [get_bd_pins DDR/c0_init_calib_complete]
  connect_bd_net -net DDR_proc_sys_reset_peripheral_aresetn [get_bd_pins peripheral_aresetn] [get_bd_pins DDR/c0_ddr4_aresetn] [get_bd_pins DDR_S_AXI_regslice/aresetn] [get_bd_pins DDR_proc_sys_reset/peripheral_aresetn]
  connect_bd_net -net aux_reset_in_1 [get_bd_pins aux_reset_in] [get_bd_pins DDR_proc_sys_reset/aux_reset_in]
  connect_bd_net -net sys_rst_1 [get_bd_pins sys_rst] [get_bd_pins DDR/sys_rst]
