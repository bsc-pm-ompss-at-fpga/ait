...
proc create_hier_cell_bridge_to_host { parentCell nameHier } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net DDR_0_S_AXI_1 [get_bd_intf_pins memory/DDR_0_S_AXI] [get_bd_intf_pins DDR_0_S_AXI]
  connect_bd_intf_net -intf_net DDR_1_S_AXI_1 [get_bd_intf_pins memory/DDR_1_S_AXI] [get_bd_intf_pins DDR_1_S_AXI]
  connect_bd_intf_net -intf_net DDR_2_S_AXI_1 [get_bd_intf_pins memory/DDR_2_S_AXI] [get_bd_intf_pins DDR_2_S_AXI]
  connect_bd_intf_net -intf_net DDR_3_S_AXI_1 [get_bd_intf_pins memory/DDR_3_S_AXI] [get_bd_intf_pins DDR_3_S_AXI]
  ...
  connect_bd_intf_net -intf_net QDMA_M_AXI [get_bd_intf_pins QDMA/M_AXI] [get_bd_intf_pins M_AXI]
  ...
  # Create port connections
  connect_bd_net -net memory_DDR_0_peripheral_aresetn [get_bd_pins memory/DDR_0_peripheral_aresetn] [get_bd_pins QDMA_M_AXI_LITE_Inter/M00_ARESETN]
  connect_bd_net -net memory_DDR_0_ui_clk [get_bd_pins memory/DDR_0_ui_clk] [get_bd_pins QDMA_M_AXI_LITE_Inter/M00_ACLK]
  connect_bd_net -net memory_DDR_1_peripheral_aresetn [get_bd_pins memory/DDR_1_peripheral_aresetn] [get_bd_pins QDMA_M_AXI_LITE_Inter/M01_ARESETN]
  connect_bd_net -net memory_DDR_1_ui_clk [get_bd_pins memory/DDR_1_ui_clk] [get_bd_pins QDMA_M_AXI_LITE_Inter/M01_ACLK]
  connect_bd_net -net memory_DDR_2_peripheral_aresetn [get_bd_pins memory/DDR_2_peripheral_aresetn] [get_bd_pins QDMA_M_AXI_LITE_Inter/M02_ARESETN]
  connect_bd_net -net memory_DDR_2_ui_clk [get_bd_pins memory/DDR_2_ui_clk] [get_bd_pins QDMA_M_AXI_LITE_Inter/M02_ACLK]
  connect_bd_net -net memory_DDR_3_peripheral_aresetn [get_bd_pins memory/DDR_3_peripheral_aresetn] [get_bd_pins QDMA_M_AXI_LITE_Inter/M03_ARESETN]
  connect_bd_net -net memory_DDR_3_ui_clk [get_bd_pins memory/DDR_3_ui_clk] [get_bd_pins QDMA_M_AXI_LITE_Inter/M03_ACLK]
  connect_bd_net -net QDMA_aclk [get_bd_pins QDMA/aclk] [get_bd_pins QDMA_M_AXI_LITE_Inter/S00_ACLK]
  connect_bd_net -net QDMA_aresetn [get_bd_pins QDMA/aresetn] [get_bd_pins QDMA_M_AXI_LITE_Inter/S00_ARESETN]
  connect_bd_net -net aclk_1 [get_bd_pins clk_app] [get_bd_pins QDMA_M_AXI_LITE_Inter/ACLK] [get_bd_pins QDMA_M_AXI_LITE_Inter/M04_ACLK]
  connect_bd_net -net interconnect_aresetn_1 [get_bd_pins clk_app_rstn] [get_bd_pins QDMA_M_AXI_LITE_Inter/ARESETN]
  connect_bd_net -net pcie_perstn_1 [get_bd_pins pcie_perstn] [get_bd_pins memory/DDR_rst] [get_bd_pins QDMA/pcie_perstn]
  connect_bd_net [get_bd_pins clk_app_rstn] [get_bd_pins QDMA_M_AXI_LITE_Inter/M04_ARESETN]
