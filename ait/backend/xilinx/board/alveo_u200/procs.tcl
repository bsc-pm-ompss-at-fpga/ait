...
namespace eval AIT {
    namespace eval board {
        proc static_logic_register_slices {} {
            ...
            # DDR 2
            AIT::AXI::add_reg_slice DDR_2 S_AXI [dict get ${::AIT::board} "arch" "slr" "memory"] 1 "" "" static_
            AIT::AXI::add_reg_slice DDR_2 S_AXI_CTRL [dict get ${::AIT::board} "arch" "slr" "memory"] 1 "" "" static_

            # DDR 3
            AIT::AXI::add_reg_slice DDR_3 S_AXI [dict get ${::AIT::board} "arch" "slr" "memory"] 2 "" "" static_
            AIT::AXI::add_reg_slice DDR_3 S_AXI_CTRL [dict get ${::AIT::board} "arch" "slr" "memory"] 2 "" "" static_

            # Hardware Runtime
            AIT::AXI::add_reg_slice Hardware_Runtime S_AXI_GP [dict get ${::AIT::board} "arch" "slr" "hwruntime"] 1 "" "" static_
