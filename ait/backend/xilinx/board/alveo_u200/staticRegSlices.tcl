proc AIT::create_DDR_reg_slice {ddrName ddrPort masterSlr migSlr} {
    set ddrRegSlice [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_register_slice:2.1 \
        bridge_to_host/memory/${ddrName}_${ddrPort}_slr_static_${masterSlr}_${migSlr} ]
    ...
    delete_bd_objs [get_bd_intf_nets -of_objects [get_bd_intf_pins bridge_to_host/memory/${ddrName}/C0_DDR4_${ddrPort}]]
