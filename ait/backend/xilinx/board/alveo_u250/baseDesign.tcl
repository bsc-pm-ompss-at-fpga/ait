...
################################################################
# This is a generated script based on design: alveo_u250_base_design
#
...
proc create_hier_cell_DDR_0 { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net c0_ddr4_ui_clk [get_bd_pins ui_clk] [get_bd_pins DDR/c0_ddr4_ui_clk] [get_bd_pins proc_sys_reset/slowest_sync_clk]
  connect_bd_net -net proc_sys_reset_peripheral_aresetn [get_bd_pins peripheral_aresetn] [get_bd_pins DDR/c0_ddr4_aresetn] [get_bd_pins proc_sys_reset/peripheral_aresetn]
...
proc create_hier_cell_DDR_3 { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net C0_DDR4_S_AXI_CTRL_1 [get_bd_intf_pins S_AXI_CTRL] [get_bd_intf_pins DDR/C0_DDR4_S_AXI_CTRL]
  connect_bd_intf_net -intf_net C0_SYS_CLK_1 [get_bd_intf_pins SYS_CLK] [get_bd_intf_pins DDR/C0_SYS_CLK]
  connect_bd_intf_net -intf_net C0_DDR4 [get_bd_intf_pins SDRAM] [get_bd_intf_pins DDR/C0_DDR4]
...
proc create_root_design { parentCell } {
  ...
  # Create port connections
  connect_bd_net -net bridge_to_host_ui_clk [get_bd_pins bridge_to_host/ui_clk] [get_bd_pins clock_generator/clk_in1]
  ...
  connect_bd_net -net processor_system_reset_interconnect_aresetn [get_bd_pins M_AXI_Inter/ARESETN] [get_bd_pins S_AXI_Inter/ARESETN] [get_bd_pins bridge_to_host/interconnect_aresetn] [get_bd_pins processor_system_reset/interconnect_aresetn]
