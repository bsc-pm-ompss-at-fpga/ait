...
namespace eval AIT {
    namespace eval board {
        ...
        proc add_ethernet_subsystem {} {
            ...
            connect_bd_intf_net [get_bd_intf_pins axi_inter_msg_send/axi_protocol_convert_0/M_AXI] [get_bd_intf_pins bridge_to_host/memory/HBM/SAXI_14]
            connect_bd_intf_net [get_bd_intf_pins axi_inter_msg_recv_memcpy/axi_protocol_convert_0/M_AXI] [get_bd_intf_pins bridge_to_host/memory/HBM/SAXI_30]
            connect_bd_intf_net [get_bd_intf_pins axi_inter_msg_recv_bufwr/axi_protocol_convert_0/M_AXI] [get_bd_intf_pins bridge_to_host/memory/HBM/SAXI_31]
        }
