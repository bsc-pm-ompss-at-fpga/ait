...
set_property DQS_BIAS    TRUE		[ get_ports  {sysclk0_clk_n} ]	;# Bank  65 VCCO - VCC1V2 Net "SYSCLK0_N"	- IO_L12N_T1U_N11_GC_A09_D25_65
...
set_property DQS_BIAS    TRUE    	[ get_ports  {sysclk1_clk_n} ]	;# Bank  69 VCCO - VCC1V2 Net "SYSCLK1_N"	- IO_L13N_T2L_N1_GC_QBC_69
