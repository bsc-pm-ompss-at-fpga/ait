...
namespace eval AIT {
    namespace eval board {
        ...
        proc instantiate_ethernet_subsystem {} {
            ...
            AIT::AXI::connect_to_mem_intf [get_bd_intf_pins axi_inter_msg_send/axi_protocol_convert_0/M_AXI] "" [get_bd_pins clk_gen_slr0/clk_400] [get_bd_pins system_reset/clk_400_rstn]
            AIT::AXI::connect_to_mem_intf [get_bd_intf_pins axi_inter_msg_recv_memcpy/axi_protocol_convert_0/M_AXI] "" [get_bd_pins clk_gen_slr0/clk_400] [get_bd_pins system_reset/clk_400_rstn]
            AIT::AXI::connect_to_mem_intf [get_bd_intf_pins axi_inter_msg_recv_bufwr/axi_protocol_convert_0/M_AXI] "" [get_bd_pins clk_gen_slr0/clk_400] [get_bd_pins system_reset/clk_400_rstn]
