...
proc create_hier_cell_QDMA { parentCell nameHier } {
  ...
  connect_bd_net -net QDMA_axi_aclk [get_bd_pins aclk] [get_bd_pins QDMA/axi_aclk] [get_bd_pins ${axi_protocol_converter}/aclk]
  connect_bd_net -net QDMA_axi_aresetn [get_bd_pins aresetn] [get_bd_pins QDMA/axi_aresetn] [get_bd_pins ${axi_protocol_converter}/aresetn]
...
proc create_hier_cell_memory { parentCell nameHier } {
  ...
  # Connect QDMA pin
  connect_bd_intf_net [get_bd_intf_pins QDMA_AXI] [get_bd_intf_pins HBM/SAXI_${::pinQDMA}_8HI]
...
proc create_hier_cell_bridge_to_host { parentCell nameHier } {
  ...
  connect_bd_intf_net [get_bd_intf_pins QDMA/M_AXI] [get_bd_intf_pins memory/QDMA_AXI]
  ...
  connect_bd_net -net QDMA_aclk [get_bd_pins QDMA/aclk] [get_bd_pins memory/QDMA_aclk] [get_bd_pins aclk]
  connect_bd_net [get_bd_pins QDMA/aresetn] [get_bd_pins memory/QDMA_aresetn] [get_bd_pins aresetn]
