...
foreach acc $accs {
	...
	for {set j 0} {$j < $accNumInstances} {incr j} {
		...
		if {[get_bd_pins -quiet ${accName}_$j/$accName_long/mcxx_outPort_*] != ""} {
		...
		if {[get_bd_pins -quiet ${accName}_$j/$accName_long/mcxx_inPort_*] != ""} {
		...
		if {[expr {[get_bd_pins -quiet ${accName}_$j/$accName_long/mcxx_instr_*] != ""} || {[get_bd_pins -quiet ${accName}_$j/$accName_long/mcxx_hwcounterPort*] != ""}]} {
			...
			if {[get_bd_pins -quiet ${accName}_$j/$accName_long/mcxx_instr_*] != ""} {
			...
			if {[get_bd_pins -quiet ${accName}_$j/$accName_long/mcxx_hwcounterPort*] != ""} {
		...
		if {[get_bd_pins -quiet ${accName}_$j/$accName_long/mcxx_freqPort*] != ""} {
