...
################################################################
# This is a generated script based on design: dummy_acc
#
...
# Hierarchical cell: dummy_acc
proc create_hier_cell_dummy_acc_1 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_dummy_acc_1() - Empty argument(s)!"}
     return
  }
...
# Hierarchical cell: dummy_acc
proc create_hier_cell_dummy_acc { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_dummy_acc() - Empty argument(s)!"}
     return
  }
  ...
  connect_bd_intf_net -intf_net dummy_acc_outStream [get_bd_intf_pins outStream] [get_bd_intf_pins dummy_acc/outStream]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: dummy_acc
  create_hier_cell_dummy_acc [current_bd_instance .] dummy_acc
